      ...
      <div className="grid md:grid-cols-3 space-y-4 md:space-y-0">
        <Card className="md:max-w-xs mx-auto shadow-lg rounded-lg overflow-hidden">
          ...
          className="w-full h-40 object-cover"/>
              ...
              <p className="text-sm text-gray-600 mt-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minus doloremque magnam molestias accusantium, ratione libero in sit exercitationem consectetur dolor!</p>
